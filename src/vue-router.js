...
const RouterViewImpl = /*#__PURE__*/ defineComponent({
    ...
    setup(props, { attrs, slots }) {
        ...
        return () => {
            ...
            const ViewComponents = matchedRoute?.components || {}
            ...
            const componentify = (comp) => h(comp, assign({}, routeProps, attrs, {
                onVnodeUnmounted,
                ref: viewRef,
            }));
            const component = componentify(ViewComponent)
            const components = Object.entries(ViewComponents).reduce((acc, [k, v]) => (acc[k] = componentify(v), acc), {})
            ...
            normalizeSlot(slots.default, { Component: component, Components: components, route }) ||
                component);
        };
    },
});
